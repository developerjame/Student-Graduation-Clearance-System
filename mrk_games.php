            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Remarks from Games</strong>
                        </li>
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                        <tr>
                            <td>
                             <div align="center"><?php echo $rowaccess['remarks_games'];  ?></div>
                            </td>
                            <td>
                             <div align="center"><span class="controls"><img src="Officers/<?php echo $rowaccess['signature_games'];?>"  width="91" height="53" border="2"/></span></div>
                            </td>
                            <td>
                             <div align="center"><?php echo $rowaccess['date_games'];  ?></div>
                            </td>
                            </tr>
                    </tbody>
                    <tfoot>
