    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    ...
                    <?php
                    if (empty($row1['photo']) || !file_exists($row1['photo'])) {
                                $row1['photo'] = 'path/to/images/photo_not_available_large.png';
                    }
                    ?>
                            <img src="../<?php echo $row1['photo'];  ?>" alt="image" width="142" height="153" class="img-circle" />
                             </span>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welcome <?php echo $row1['fullname']; ?></span>
                </li>
                <li class="dropdown">
    ...
    ?>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">Ksh:<?php echo number_format((float) $tot_fee ,2); ?> </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             
...
<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">Ksh:<?php echo number_format((float) $tot_pay ,2); ?></h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>    
					...
					<div class="col-lg-3">
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">Ksh:<?php echo number_format((float) $outstanding_fee ,2); ?>  </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             
