...
$status = 'Active';
 ...
 $sql = "SELECT * FROM officers WHERE username='" .$username . "' and password = '". $password."' and status = '". $status."'";
...
<title>Officer Login Form | Online Clearance System</title>
...
<div class="login-box">
  ...
  <img src="../images/logo2.png" alt="" width="200" height="200">
   </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg style2">OFFICER LOGIN FORM </p>
