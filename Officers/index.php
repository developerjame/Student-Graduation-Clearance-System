...
<head>
  ...
  <title>Welcome to Officer Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="../images/logo1.png" alt=" Logo"  width="155" height="99" class="" style="opacity: .8">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard for Officer - <?php echo $row2['designation'];  ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
		   ...
		   <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Ksh.<?php echo number_format((float) $tot_pay ,2); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
