...
//save users details
$query = "INSERT into `officers` (username,password,designation,fullname,email,status,photo)
...
<head>
  ...
  <title>Create Officer|Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <option value="Dean_of_Student">Dean of Student</option>
