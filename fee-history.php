...
<span class="m-r-sm text-muted welcome-message">Welcome to <?php echo $rowaccess['fullname'];?></span>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Payment History</strong>                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                          <thead>
                            <tr>
                              ...
                              <th><div align="center" class="style1">Payment ID</div></th>
                              <th><div align="center" class="style1">Amount </div></th>
                              <th><div align="center" class="style1">Date of Payment</div></th>
                          </thead>
                          <tbody>
                            <?php
		  ...
		  ?>
                            <tr class="gradeX">
                              <td><?php echo $cnt;  ?></td>
                              <td><div align="center"><?php echo $row['feeID'];  ?> </div></td>
                              <td><div align="center">Ksh.<?php echo number_format((float)$row['amount'] ,2); ?></div></td>
                              <td class="center"><div align="center"><?php echo $row['datepaid'];  ?></div></td>
                            </tr>
                            <?php $cnt=$cnt+1;} ?>
                          </tbody>
                          <tfoot>
        ...
        <div class="footer">
            ...
            <div>
                <strong></strong><?php include('footer.php');    ?></strong> 
            </div>
        </div>
